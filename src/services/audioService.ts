...
export class AudioLessonService {
  ...
  private cleanTextForSpeech(text: string): string {
    return text
      ...
      // V-speeds (must come before generic letter replacements)
      .replace(/\bVx\b/g, 'V-X, best angle of climb speed')
      .replace(/\bVy\b/g, 'V-Y, best rate of climb speed')
      .replace(/\bVso\b/g, 'V-S-O, stall speed in landing configuration')
      .replace(/\bVs0\b/g, 'V-S-O, stall speed in landing configuration')
      .replace(/\bVs1\b/g, 'V-S-one, stall speed in clean configuration')
      .replace(/\bVa\b/g, 'V-A, maneuvering speed')
      .replace(/\bVne\b/g, 'V-N-E, never exceed speed')
      .replace(/\bVno\b/g, 'V-N-O, maximum structural cruising speed')
      .replace(/\bVfe\b/g, 'V-F-E, maximum flap extended speed')
      .replace(/\bVle\b/g, 'V-L-E, maximum landing gear extended speed')
      .replace(/\bVr\b/g, 'V-R, rotation speed')
      .replace(/\bVlof\b/g, 'V-LOF, lift-off speed')
      // Common abbreviations (most frequently used)
      .replace(/\bCFI\b/g, 'Certified Flight Instructor')
      .replace(/\bCFII\b/g, 'Certified Flight Instructor Instrument')
      .replace(/\bMEI\b/g, 'Multi-Engine Instructor')
      .replace(/\bDPE\b/g, 'Designated Pilot Examiner')
      .replace(/\bACS\b/g, 'Airman Certification Standards')
      .replace(/\bFAA\b/g, 'F-A-A')
      .replace(/\bPTS\b/g, 'Practical Test Standards')
      .replace(/\bPOH\b/g, "Pilot's Operating Handbook")
      .replace(/\bAFM\b/g, 'Airplane Flight Manual')
      .replace(/\bAGL\b/g, 'above ground level')
      .replace(/\bMSL\b/g, 'mean sea level')
      .replace(/\bRPM\b/g, 'R-P-M')
      .replace(/\bATC\b/g, 'air traffic control')
      .replace(/\bVFR\b/g, 'V-F-R')
      .replace(/\bIFR\b/g, 'I-F-R')
      .replace(/\bVMC\b/g, 'V-M-C')
      .replace(/\bIMC\b/g, 'I-M-C')
      .replace(/\bATIS\b/g, 'A-T-I-S')
      .replace(/\bCTAF\b/g, 'C-TAF')
      .replace(/\bUNICOM\b/g, 'unicom')
      .replace(/\bNOTAM\b/g, 'no-tam')
      .replace(/\bMETAR\b/g, 'metar')
      .replace(/\bTAF\b/g, 'terminal area forecast')
      .replace(/\bSIGMET\b/g, 'sig-met')
      .replace(/\bAIRMET\b/g, 'air-met')
      // Risk/Decision abbreviations
      .replace(/\bADM\b/g, 'Aeronautical Decision Making')
      .replace(/\bCRM\b/g, 'Crew Resource Management')
      .replace(/\bSRM\b/g, 'Single Pilot Resource Management')
      .replace(/\bPAVE\b/g, 'pave')
      .replace(/\bIMSAFE\b/g, "I'm safe")
      .replace(/\bFRAT\b/g, 'flight risk assessment tool')
      // Instruments/Navigation
      .replace(/\bVOR\b/g, 'V-O-R')
      .replace(/\bNDB\b/g, 'N-D-B')
      .replace(/\bILS\b/g, 'I-L-S')
      .replace(/\bGPS\b/g, 'G-P-S')
      .replace(/\bRNAV\b/g, 'R-nav')
      .replace(/\bLPV\b/g, 'L-P-V')
      .replace(/\bLNAV\b/g, 'L-nav')
      .replace(/\bVNAV\b/g, 'V-nav')
      // Technical terms
      .replace(/\bAOA\b/g, 'angle of attack')
      .replace(/\bCG\b/g, 'center of gravity')
      .replace(/\bMAC\b/g, 'mean aerodynamic chord')
      .replace(/\bCHT\b/g, 'cylinder head temperature')
      .replace(/\bEGT\b/g, 'exhaust gas temperature')
      .replace(/\bMP\b/g, 'manifold pressure')
      .replace(/\bTAS\b/g, 'true airspeed')
      .replace(/\bCAS\b/g, 'calibrated airspeed')
      .replace(/\bKIAS\b/g, 'knots indicated airspeed')
      .replace(/\bKCAS\b/g, 'knots calibrated airspeed')
      .replace(/\bKTAS\b/g, 'knots true airspeed')
